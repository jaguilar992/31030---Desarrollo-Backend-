...
const contenedor = new Contenedor("src/database/trainer.json");
const contenedorPokemon = new Contenedor("src/database/pokemon.json");
...
class TrainerService {
  ...
  static getInfo(id) {
    ...
    const pokemons = trainer.pokemon.map((pokemonId) =>
      contenedorPokemon.getById(pokemonId)
    );
